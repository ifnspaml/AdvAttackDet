...
def ssim(X, Y, win_size=11, win_sigma=1.5, win=None, data_range=1.0, size_average=False, full=False):
    r""" interface of ssim
    Args:
...
class SSIM(torch.nn.Module):
    def __init__(self, win_size=11, win_sigma=1.5, data_range=1.0, size_average=False, channel=1):
        r""" class for ssim
        Args:
            win_size: (int, optional): the size of gauss kernel
            win_sigma: (float, optional): sigma of normal distribution
